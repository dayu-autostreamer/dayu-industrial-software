class NetworkAPIPath:
    ...
    BACKEND_EVENT_RESULT = '/event_result'
    BACKEND_EVENT_DETAIL = '/event_detail'
...
class NetworkAPIMethod:
    ...
    BACKEND_EVENT_RESULT = 'GET'
    BACKEND_EVENT_DETAIL = 'GET'
    BACKEND_FREE_TASK_RESULT = 'GET'
    BACKEND_FREE_VISUALIZATION_CONFIG = 'GET'
