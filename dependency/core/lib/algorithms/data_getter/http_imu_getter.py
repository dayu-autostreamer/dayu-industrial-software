...
__all__ = ('HttpIMUGetter',)


@ClassFactory.register(ClassType.GEN_GETTER, alias='http_imu')
class HttpIMUGetter(BaseDataGetter, abc.ABC):
    def __init__(self):
        self.file_name = None
    ...
    def __call__(self, system):
        ...
        LOGGER.info(f'[IMU Simulation] source {system.source_id}: sleep {sleep_time}s')
